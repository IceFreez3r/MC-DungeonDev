...
execute if entity @s[nbt={data:{CustomName:'{"text":"demo/stairway0"}'}}] run function dg:dungeons/demo/stairway0
execute if entity @s[nbt={data:{CustomName:'{"text":"demo/quad1"}'}}] run function dg:dungeons/demo/quad1
...
execute if entity @s[nbt={data:{CustomName:'{"text":"demo/2/quad1"}'}}] run function dg:dungeons/demo/2/quad1
execute if entity @s[nbt={data:{CustomName:'{"text":"demo/2/stairway1"}'}}] run function dg:dungeons/demo/2/stairway1
