...
execute if score .level dg.build matches 0 run function s:dungeons/demo/deadend
execute if score .level dg.build matches 1 run function s:dungeons/1_blackstone_tunnels/deadend
