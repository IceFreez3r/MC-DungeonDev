...
execute if score .level dg.build matches 1 run function dg:dungeons/demo/deadend
execute if score .level dg.build matches 2 run function dg:dungeons/demo2/deadend
