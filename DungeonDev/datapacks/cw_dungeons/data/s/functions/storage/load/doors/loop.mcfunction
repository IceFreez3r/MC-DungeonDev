...
execute as @e[type=marker,tag=dg.new,limit=1] run function s:storage/load/door
...
execute if score .door_count dg.storage matches 1.. run function s:storage/load/doors/loop
