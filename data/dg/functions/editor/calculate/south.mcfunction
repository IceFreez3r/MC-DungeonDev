...
execute if score @s dg.door.right matches 0.. if score @s dg.door.left matches 0.. if score @s dg.door.up matches 0.. if score @s dg.door.down matches 0.. if score @s dg.door.perpendicular matches 0.. if score @s dg.door.perpendicular < .sZ dg run function dg:storage/store/door
...
execute if entity @s[tag=dg.door.exit] if score @s dg.door.right matches 0.. if score @s dg.door.left matches 0.. if score @s dg.door.up matches 0.. if score @s dg.door.down matches 0.. if score @s dg.door.perpendicular matches 0.. if score @s dg.door.perpendicular < .sZ dg run tellraw @p [{"text":" | S=["},{"score":{"name":"@s","objective":"dg.door.left"}},{"text":","},{"score":{"name":"@s","objective":"dg.door.right"}},{"text":","},{"score":{"name":"@s","objective":"dg.door.up"}},{"text":","},{"score":{"name":"@s","objective":"dg.door.down"}},{"text":","},{"score":{"name":"@s","objective":"dg.door.perpendicular"}},{"text":"] (Exit)"}]
