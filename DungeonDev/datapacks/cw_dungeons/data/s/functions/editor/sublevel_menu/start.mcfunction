...
execute if score @s dg.sublevel matches 1 run function s:editor/sublevel_menu/1
execute if score @s dg.sublevel matches 2 run function s:editor/sublevel_menu/2
execute if score @s dg.sublevel matches 3 run function s:editor/sublevel_menu/3
execute if score @s dg.sublevel matches 4 run function s:editor/sublevel_menu/4
execute if score @s dg.sublevel matches 5 run function s:editor/sublevel_menu/5
